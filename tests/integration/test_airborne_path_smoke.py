...
다음 노드들이 한 줄로 작동하는지 확인:
  ...
  ④ LiveAirborneBbReversalKstHours 의 KST {8,11,16,22}시 gate
...
# KST 11:00 = UTC 02:00 → gate ∈ {8,11,16,22} 에 포함
_GATE_ON_LAST_UTC = "2026-05-30T02:00:00"
# KST 13:00 = UTC 04:00 → gate 미포함
...
@pytest.mark.asyncio
async def test_e2e_gate_on_kst11_emits_buy():
    """KST 11시 (gate ON) + BB long fire pattern → BUY 시그널 + OrderIntent."""
    ...
    assert intents, (
        "KST 11시 BB long fire 인데 OrderIntent 0건. wiring 의 한 노드가 깨짐.\n"
