...
4. **자석 이론** (별도 노트 [[37-multi-tf-fractal-trading]] 참조): 이격이 클수록 평균회귀 압력
...
- [[37-multi-tf-fractal-trading]] — VWMA 의 멀티프레임 적용 (자매 노트)
- [[38-cross-sectional-momentum-crypto]] — 크립토 RS 필터 (Variant E)
- [[39-orderbook-flow-features]] — 호가창 마이크로구조 feature (Variant G/H)
