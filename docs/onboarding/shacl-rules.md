...
- [[ontology-primer]] — 본 제약이 적용될 온톨로지 기초
- [[frontmatter-guide]] — 프론트매터 규약 (SHACL 위반 방지 1차 방어선)
- [[25-fibo-alignment]] — FIBO 설계 관례 (skos:definition 필수·owl:versionIRI) 에서 SHACL 제약으로 차용 가능한 패턴
- [[23-graphrag-for-trading-vault]] — retrieval 대상 노트의 SHACL 유효성 전제
- [[15-llm-agent-layer]] — LLM 이 생성한 `.draft.md` 도 승격 전 SHACL 통과 필수
