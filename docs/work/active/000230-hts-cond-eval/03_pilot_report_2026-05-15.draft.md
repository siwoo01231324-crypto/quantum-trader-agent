# HTS 검색식 1일 pilot — 2026-05-15

옵션 A: KIS 1분봉 lake + 3종 검색식 evaluator + +2/-2% 시뮬레이션.

- 거래일: 2026-05-15 (1일)
- 필터된 universe: 281 종목 (FDR snapshot A+B+C eod 근사)
- 1m 데이터 적재 (date×symbol 카운트): 0
...
|---------|--------:|-------:|-----:|---------:|--------:|----------|
| dts | 0 | 0 | 0 | 0.0% | +0.000% | **skip** |
| wait5m | 0 | 0 | 0 | 0.0% | +0.000% | **skip** |
| swing | 0 | 0 | 0 | 0.0% | +0.000% | **skip** |

## 한계
1. 표본 1거래일 → 통계 신뢰도 낮음. 옵션 B 로 5거래일 누적 후 본 검증 필요.
