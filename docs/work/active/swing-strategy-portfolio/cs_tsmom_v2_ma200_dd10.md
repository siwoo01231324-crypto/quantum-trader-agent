...
- Crash guard: KOSPI 252d drawdown ≤ -10%
- Regime filter: KOSPI close > MA200
...
| Sharpe | 0.711 | 0.656 |
| MDD | -43.80% | -35.71% |
| Ann. Return | 14.80% | 11.98% |
| Calmar | 0.338 | — |
| Final Equity (rebased 1.0) | 2.240 | — |
| Avg Holdings (when invested) | 20.0 | — |
| Avg Annual Turnover (one-way) | 12.71× | — |
| Exposure (days invested) | 55.4% | 100% |
