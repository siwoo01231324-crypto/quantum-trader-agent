...
- [x] `src/backtest/strategies/live_macross_regime_v1.py` (LiveScannerMixin, on_bar 레짐 게이트)
- [x] `docs/specs/strategies/live-macross-regime-v1.md` (본 파일)
- [x] `tests/backtest/test_live_macross_regime_v1.py` (6+ on_bar 케이스)
