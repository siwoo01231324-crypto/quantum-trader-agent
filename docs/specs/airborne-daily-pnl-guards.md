...
| `AIRBORNE_DAILY_PROFIT_TARGET_PCT` | 5.0 | 이익목표 % of equity (3.5→5.0 2026-06-28 상향) |
| `AIRBORNE_DAILY_GIVEBACK_PCT` | 40 | 고점이익 반납 비율 % |
| `AIRBORNE_DAILY_GIVEBACK_ARM_PCT` | 3.0 | 고점이 이 %(of equity) 도달해야 락 무장 (target 3.5 보다 낮아야 의미. 1.0 은 2026-06-28 +1.2% 노이즈 종일정지 사고 → 3.0) |
